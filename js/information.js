class InfomationEvent {
    static #instance = null;
    static getInstance() {
        if(this.#instance == null) {
            this.#instance = new InfomationEvent();
        }
    ...
    addEventAboutMeSaveClick() {
        ...
        aboutMeSaveButton.onclick = () => {
            ...
            const userInfo = InfomationService.getInstance().userInfo;
    ...
    addEventIntroduceModifyClick() {
        const aboutMeModifyButton = document.querySelector(".m-introduce");
        aboutMeModifyButton.onclick = () => {
            const aboutMeSaveButton = document.querySelector(".s-introduce");
            aboutMeSaveButton.classList.remove("button-hidden");
            aboutMeModifyButton.classList.add("button-hidden");
...
class InfomationService {
    ...
    static getInstance() {
        if(this.#instance == null) {
            this.#instance = new InfomationService();
        }
        return this.#instance;
    }
...
class FileService {
    ...
    // addEventChangeDisabled() {
    //     const infoDtail = document.querySelector(".info-detail .info-input-container");
    //     const modifyButton = document.querySelector("modify-button .m-aboutme");

    //     modifyButton.onclick = () => {
    //         infoDtail.document.querySelectorAll(".info-input");
    //         infoDtail[0].disabled = flase;
    //     }
